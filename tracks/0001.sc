...
~reverb = {Out.ar(0, FreeVerb.ar(In.ar(~fxBus, 2), mix: 0.6, room: 0.2, mul: 0.5))};
~reverb.play;

(
SynthDef(\pad, {arg freq = 60, amp = 0.1, gate = 1, fmod = 1;
...
(
  SynthDef(\bassTone, {arg freq = 60, amp = 0.7, gate = 1;
